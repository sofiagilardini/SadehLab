...
single_cebra_model = cebra.CEBRA(
    ...
    # time offsets was originally 10 (for models 5, 6 7 8)
    time_offsets = 1,
    output_dimension = 9, # this is the change specific to this script (otherise is 3)
    device = device,
    verbose = True,
...
# Train the models for non-stationary data for FilmID (./training_results/models_30)
# aux_f4.trainCebraBehaviour(models[0], s3_neuraldata_tr, s3_neuraldata_test, s3_filmID_tr, s3_filmID_test, 3, 'm30_s3', s3_indices_tr, s3_indices_test, 'models_30')
# aux_f4.trainCebraBehaviour(models[1], s4_neuraldata_tr, s4_neuraldata_test, s4_filmID_tr, s4_filmID_test, 4, 'm30_s4', s4_indices_tr, s4_indices_test, 'models_30')
# aux_f4.trainCebraBehaviour(models[2], s5_neuraldata_tr, s5_neuraldata_test, s5_filmID_tr, s5_filmID_test, 5, 'm30_s5', s5_indices_tr, s5_indices_test, 'models_30')

# # train the models for stationary data for FilmID (./training_results/models_31)

# aux_f4.trainCebraBehaviour(models[3], s3_neuraldata_tr_st, s3_neuraldata_test_st, s3_filmID_tr_st, s3_filmID_test_st, 3, 'm31_s3', s3_indices_tr_st, s3_indices_test_st, 'models_31')
# aux_f4.trainCebraBehaviour(models[4], s4_neuraldata_tr_st, s4_neuraldata_test_st, s4_filmID_tr_st, s4_filmID_test_st, 4, 'm31_s4', s4_indices_tr_st, s4_indices_test_st, 'models_31')
# aux_f4.trainCebraBehaviour(models[5], s5_neuraldata_tr_st, s5_neuraldata_test_st, s5_filmID_tr_st, s5_filmID_test_st, 5, 'm31_s5', s5_indices_tr_st, s5_indices_test_st, 'models_31')    
...
# # train the models for non-stationary data for FrameID (./training_results/models_32) -- DONE

# aux_f4.trainCebraBehaviour(models[6], s3_neuraldata_tr, s3_neuraldata_test, s3_frameID_tr, s3_frameID_test, 3, 'm32_s3', s3_indices_tr, s3_indices_test, 'models_32')
# aux_f4.trainCebraBehaviour(models[7], s4_neuraldata_tr, s4_neuraldata_test, s4_frameID_tr, s4_frameID_test, 4, 'm32_s4', s4_indices_tr, s4_indices_test, 'models_32')
# aux_f4.trainCebraBehaviour(models[8], s5_neuraldata_tr, s5_neuraldata_test, s5_frameID_tr, s5_frameID_test, 5, 'm32_s5', s5_indices_tr, s5_indices_test, 'models_32')

# # train the models for stationary data for FrameID (./training_results/models_33) -- DONE

# aux_f4.trainCebraBehaviour(models[9], s3_neuraldata_tr_st, s3_neuraldata_test_st, s3_frameID_tr_st, s3_frameID_test_st, 3, 'm33_s3', s3_indices_tr_st, s3_indices_test_st, 'models_33')
# aux_f4.trainCebraBehaviour(models[10], s4_neuraldata_tr_st, s4_neuraldata_test_st, s4_frameID_tr_st, s4_frameID_test_st, 4, 'm33_s4', s4_indices_tr_st, s4_indices_test_st, 'models_33')
# aux_f4.trainCebraBehaviour(models[11], s5_neuraldata_tr_st, s5_neuraldata_test_st, s5_frameID_tr_st, s5_frameID_test_st, 5, 'm33_s5', s5_indices_tr_st, s5_indices_test_st, 'models_33')
...
s3_model_5 = CEBRA.load('./training_results/models_30/cebra_model_m30_s3.pt', map_location=torch.device("cpu"))
s4_model_5 = CEBRA.load('./training_results/models_30/cebra_model_m30_s4.pt', map_location=torch.device("cpu"))
s5_model_5 = CEBRA.load('./training_results/models_30/cebra_model_m30_s5.pt', map_location=torch.device("cpu"))

# load the models for stationary data (filmID)
s3_model_6 = CEBRA.load('./training_results/models_31/cebra_model_m31_s3.pt', map_location=torch.device("cpu"))
s4_model_6 = CEBRA.load('./training_results/models_31/cebra_model_m31_s4.pt', map_location=torch.device("cpu"))
s5_model_6 = CEBRA.load('./training_results/models_31/cebra_model_m31_s5.pt', map_location=torch.device("cpu"))
...
s3_model_7 = CEBRA.load('./training_results/models_32/cebra_model_m32_s3.pt', map_location=torch.device("cpu"))
s4_model_7 = CEBRA.load('./training_results/models_32/cebra_model_m32_s4.pt', map_location=torch.device("cpu"))
s5_model_7 = CEBRA.load('./training_results/models_32/cebra_model_m32_s5.pt', map_location=torch.device("cpu"))

# load the models for stationary data (frameID)

s3_model_8 = CEBRA.load('./training_results/models_33/cebra_model_m33_s3.pt', map_location=torch.device("cpu"))
s4_model_8 = CEBRA.load('./training_results/models_33/cebra_model_m33_s4.pt', map_location=torch.device("cpu"))
s5_model_8 = CEBRA.load('./training_results/models_33/cebra_model_m33_s5.pt', map_location=torch.device("cpu"))
